...
public class newLogin extends CommonLib {
	@BeforeClass
	...
	@DataProvider(name = "test_06_login_validate_login_success_test")
	public Object[][] createData1() {
	 return new Object[][] {
	   { "dalip.kumar@venturepact.com", "defaultPassword"},
	   { "komaldhillon28@gmail.com", "defaultPassword"},
	 };
	}
	...
	@Test(dataProvider = "test_06_login_validate_login_success_test")
	public static void test_06_login_validate_login_success_test(String n1, String n2) throws InterruptedException, IOException {
	...
	@Test(dependsOnMethods = { "test_06_login_validate_login_success_test" })

...
public class logicJump extends CommonLib {
	...
	public Object[][] createData1() {
		return new Object[][] { { "dalip", "dalip.kumar@venturepact.com" },
				{ "dalip+1", "dalip.kumar+1@venturepact.com" }, { "dalip+2", "dalip.kumar+2@venturepact.com" },
				{ "dalip+3", "dalip.kumar+3@venturepact.com" }, { "dalip+4", "dalip.kumar+4@venturepact.com" } };
